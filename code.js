window.onload = function() {
  ...
  function selectEmployee(block) {
    ...
    employees[index].staj ? getNode("employeeStaj").innerText = employees[index].staj : getNode("employeeStaj").innerText = "Не вказано";
  }
  ...
  function editEmployee() {
    ...
    els.staj.value = employees[index].staj;
    els.photo.value = "";
  ...
  getNode("add").addEventListener("click",function(){
    ...
    getNode("photo").src = "https://icon-library.com/images/avatar-png-icon/avatar-png-icon-3.jpg";
